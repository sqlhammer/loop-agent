...
- [x] Task 15: Final green pass — run `dotnet format`, confirm `verify.ps1 -Accept` exits 0 with all acceptance criteria passing, and update `PROGRESS.md` (turns AC16 green).
